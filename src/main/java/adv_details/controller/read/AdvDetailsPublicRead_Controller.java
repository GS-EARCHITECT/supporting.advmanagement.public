package adv_details.controller.read;
...
@CrossOrigin(origins = "*")
@RestController
@RequestMapping("/advDetailsPublicReadMgmt")
public class AdvDetailsPublicRead_Controller {

	// private static final Logger Advgger =
	// LoggerFactory.getLogger(AdvSchd_AdvSchd_Lontroller.class);

	@Autowired
	private I_AdvDetailsPublicRead_Service advDetailsPublicReadServ;
	...
	public ResponseEntity<CopyOnWriteArrayList<AdvDetail_DTO>> getAllAdvDetails() {
		CompletableFuture<CopyOnWriteArrayList<AdvDetail_DTO>> completableFuture = advDetailsPublicReadServ.getAllAdDetails();
	...
	public ResponseEntity<CopyOnWriteArrayList<AdvDetail_DTO>> getSelectAdvDetails(
		...
		CompletableFuture<CopyOnWriteArrayList<AdvDetail_DTO>> completableFuture = advDetailsPublicReadServ.getSelectAdDetails(ids);
		CopyOnWriteArrayList<AdvDetail_DTO> advDetail_DTOs = completableFuture.join();
		return new ResponseEntity<>(advDetail_DTOs, HttpStatus.OK);
	}
	...
	public ResponseEntity<CopyOnWriteArrayList<AdvDetail_DTO>> getSelectAdvDetailsForParties(
			@RequestBody CopyOnWriteArrayList<Long> ids) {
		CompletableFuture<CopyOnWriteArrayList<AdvDetail_DTO>> completableFuture = advDetailsPublicReadServ.getSelectAdDetailsByParties(ids);
		CopyOnWriteArrayList<AdvDetail_DTO> advDetail_DTOs = completableFuture.join();
		return new ResponseEntity<>(advDetail_DTOs, HttpStatus.OK);
	}
	...
	public ResponseEntity<CopyOnWriteArrayList<AdvDetail_DTO>> getSelectAdvDetailsForServices(
			@RequestBody CopyOnWriteArrayList<Long> ids) {
		CompletableFuture<CopyOnWriteArrayList<AdvDetail_DTO>> completableFuture = advDetailsPublicReadServ.getSelectAdDetailsByServices(ids);
		CopyOnWriteArrayList<AdvDetail_DTO> advDetail_DTOs = completableFuture.join();
		return new ResponseEntity<>(advDetail_DTOs, HttpStatus.OK);
	}
	...
	public ResponseEntity<CopyOnWriteArrayList<AdvDetail_DTO>> getSelectAdvDetailsForResources(
			@RequestBody CopyOnWriteArrayList<Long> ids) {
		CompletableFuture<CopyOnWriteArrayList<AdvDetail_DTO>> completableFuture = advDetailsPublicReadServ.getSelectAdDetailsByResources(ids);
		CopyOnWriteArrayList<AdvDetail_DTO> advDetail_DTOs = completableFuture.join();
		return new ResponseEntity<>(advDetail_DTOs, HttpStatus.OK);
	}
